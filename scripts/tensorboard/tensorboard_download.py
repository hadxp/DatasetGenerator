...
TAGS = ["train/epoch_loss", "train/loss", "train/avr_loss", "train/avr_epoch_loss", "train/ema_loss", "train/automagic_avg_lr", "loss/current", "loss/epoch", "lr/unet"]
        ...
        if RUN_NAME in run:
            ...
            for tag in TAGS:
                try:
                    ...
                    all_data[f"{run_name}__{tag.replace('/', '_')}"] = {
