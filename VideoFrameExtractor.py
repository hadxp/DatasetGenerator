...
from numpy_pil_conv import numpy_to_pil
from image_preprocessor import preprocess_image, load_upscaler_model
...
class VideoFrameExtractor:
    ...
    def __init__(self, file_path: Union[str, Path], model: Swin2SRImageProcessor,
                 processor: Swin2SRForImageSuperResolution):
        self.file_path = file_path
        self.upscale_model = model
        self.upscale_processor = processor

    def get_video(self) -> Tuple[List[Image.Image], VideoInfo]:
        ...
        try:
            ...
            try:
                ...
                total_frames = int(duration * fps) if duration and fps else 0 # Estimate total frames
